...
<div class="card m-6">
    <div class="card-body">
        {!! Form::open( ['url' => 'laporan/data-master/cek', 'method' => 'GET']) !!}
        ...
        <div class="row align-item-center mb-1">
            ...
            {!! Form::select(null, ['Admin' => 'Admin', 'Barang' => 'Barang', 'Pelanggan' => 'Pelanggan', 'Supplier' =>
            'Supplier'], ['class' => 'col-2 text-center']) !!}
        </div>
        <div class="row align-item-center mb-1">
