                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4>
                                    ...
                                    <small class="float-right">Tanggal: {{ $simpanan->tanggal }}</small>
                                </h4>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                <a href="{{ route('data.index') }}" class="btn btn-light float-right"><i
                                    class="fas fa-print"></i> Kembali</a>
                                <a href="invoice-print.html" rel="noopener" target="_blank" class="btn btn-danger float-right"><i
