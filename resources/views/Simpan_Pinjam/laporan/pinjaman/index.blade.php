        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <a href="{{ route('lap-pinjaman.print-all') }}" class="btn btn-info btn-sm float-left" style="margin-top: 10px; margin-left: 8px;"><i class="fas fa-print"></i>&nbsp;Cetak Semua</a>
                    <form id="form-pinjaman" action="{{ route('lap-pinjaman.show') }}" role="form" method="post" enctype="multipart/form-data">
                        @csrf
