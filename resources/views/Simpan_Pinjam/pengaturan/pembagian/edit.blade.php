...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Edit Pembagian SHU</li>
@endsection
        ...
        <div class="col-md-12">
            <div class="card card-warning card-outline">
                <div class="card-header">
                    <h3 class="card-title">Edit Pembagian SHU</h3>
                </div>
                <div class="card-body col-md-6 mx-auto">
                    <form id="form-pembagian" action="{{ route('pembagian.update', $pembagianSHU->id) }}" role="form"
