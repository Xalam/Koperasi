        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><b>Daftar Pengaturan</b></h3>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <p style="margin-bottom: 5px;" class="text-danger">Klik <b>"Hapus Jurnal"</b> untuk menghapus
                                semua jurnal umum</p>
                            <div class="form-group">
                                <a href="#mymodal" data-remote="{{ route('list.modal-all', 1) }}" data-toggle="modal"
                                    data-target="#mymodal" class="btn btn-danger btn-sm"><i
                                        class="far fa-trash-alt"></i>&nbsp; Hapus Jurnal</a>
                            </div>
                        </div>
                    </div>
                </div>
